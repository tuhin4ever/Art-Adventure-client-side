      ...
      <div className="relative">
        ...
        <div className="absolute my-60 mx-auto w-full text-center text-white z-10">
          <Fade delay={1e3} cascade damping={1e-1}>
            ...
            <p className="text-2xl mt-5 Permanent-text">
              This is your golden opportunity to unleash your imagination,
        ...
        <div className="absolute my-60 mx-auto w-full text-center text-white z-10">
          <Fade delay={1e3} cascade damping={1e-1}>
            ...
            <p className="text-2xl mt-5 Permanent-text">
              ...
              possibilities. <br /> Our expert instructors will guide you
              through each step, <br /> unveiling secrets and techniques that
              will enhance your artistic skills.
            </p>
          </Fade>
        </div>
        <img
